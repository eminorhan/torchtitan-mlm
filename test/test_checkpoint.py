...
class TestCheckpoint:
    def test_c4_resumption(self):
        ...
        dl = self._build_dataloader(dataset_name, dataset_path, batch_size, seq_len, world_size, rank)
    ...
    def _build_dataloader(self, dataset_name, dataset_path, batch_size, seq_len, world_size, rank):
