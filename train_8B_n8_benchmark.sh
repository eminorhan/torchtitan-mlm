...
#SBATCH --job-name=train_llama_mlm_8B_n8_benchamrk
#SBATCH --output=train_llama_mlm_8B_n8_benchmark_%A_%a.out
#SBATCH --array=0
#SBATCH --qos=debug
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/llama3_8b_n8_benchmark.toml"}
